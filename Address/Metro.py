...
class Metro(YuCRM):
    ...
    def __full_url(self):
        return f'{super().url.format(login=super().login, token=super().token)}{URL_METRO}'

    def List(self,
             id=None, created_at=None, updated_at=None, name=None, page=None, limit=None, mode=None,
